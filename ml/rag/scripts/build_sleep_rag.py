"""수면 가이드 PDF를 ChromaDB 컬렉션 ``sleep_guidelines``로 구축한다."""
...
DOC_DIR = ROOT / "rag" / "documents" / "sleep"
...
def build_sleep_vectorstore() -> None:
    """``rag/documents/sleep/`` 내 PDF를 로드해 임베딩 후 ChromaDB에 저장한다."""
